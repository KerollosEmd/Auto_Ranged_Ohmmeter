...
u16 AROM_Au16DigitalReadings[7] = { 0 };
/*
...
int main(void) {
	...
	while (1) {
		...
		/*
		 * Start debugging section to see the content of the reading array
		 */
//		for (Local_u8Index = 0; Local_u8Index < 7; Local_u8Index++) {
//			LCD_voidWriteCommand(LCD_Clear);
//			LCD_voidWriteString(Local_u8String_R1);
//			LCD_voidWritNumber(AROM_Au16Resistances[Local_u8Index]);
//			LCD_voidGoToXY(0, LCD_u8_LINE_2);
//			LCD_voidWriteString(Local_u8String_ADC);
//			LCD_voidWritNumber(AROM_Au16DigitalReadings[Local_u8Index]);
//			_delay_ms(500);
//		}
		/*
		...
		for (Local_u8Index = 6; Local_u8Index >= 0; Local_u8Index--) {
			...
			if ((AROM_Au16DigitalReadings[Local_u8Index] >= 430)
					|| (AROM_Au16DigitalReadings[Local_u8Index] < 430
							&& Local_u8Index == 0)) {
				Local_f32VoltX_mv =
						(f32) (AROM_Au16DigitalReadings[Local_u8Index]
								* (5000UL)) / 1024;
				Local_f32ResX = (Local_f32VoltX_mv
						* AROM_Au16Resistances[Local_u8Index])
